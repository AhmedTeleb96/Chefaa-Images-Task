package com.teleb.chefaaimagestask.data.utils
...
class InternetConnectionLiveData(context: Context) : LiveData<Boolean>() {
    ...
    companion object{
        fun getInstance(context: Context) = InternetConnectionLiveData(context)
    }
    ...
    private fun createNetworkCallback() = object : ConnectivityManager.NetworkCallback() {
        ...
        override fun onAvailable(network: Network) {
            ...
            if (hasInternetCapability == true) {
                ...
                CoroutineScope(CoroutineExceptionHandler { _, _ ->  }+Dispatchers.IO).launch {
